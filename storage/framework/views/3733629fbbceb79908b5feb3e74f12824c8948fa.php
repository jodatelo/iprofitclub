                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Bienvenido de nuevo a iProfits</p>
                            </div>
                            <div class="p-2 mt-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'admin@themesbrand.com')); ?>" id="username" name="email" placeholder="Ingrese su email">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        <div class="float-end">
                                            <a href="auth-pass-reset-basic" class="text-muted">Olvidé mi contraseña</a>
                                        </div>
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Ingrese su contraseña" id="password-input" value="123456">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iprofitclub\resources\views/auth/login.blade.php ENDPATH**/ ?>