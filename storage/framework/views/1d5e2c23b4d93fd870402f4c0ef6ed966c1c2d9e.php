    ...
    <div class="layout-width">
        <div class="navbar-header">
            <div class="d-flex col-4">
                ...
                <!-- App Search-->
                <input type="text" class="form-control col-12" id="basiInput" value="http://iprofit.club/register/<?php echo e(auth()->user()->email); ?>" disabled>
                &nbsp;&nbsp;
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Cliente</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
...
<?php /**PATH C:\xampp\htdocs\iprofitclub\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>