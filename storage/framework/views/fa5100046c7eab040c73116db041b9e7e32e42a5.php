        ...
        <div class="col-xl-3">
            <div class="card card-h-100">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-primary w-100" id="btn-new-event" <?php echo e($disable); ?>><i class="mdi mdi-plus"></i>Crear nueva póliza</button>
            ...
            <div>
                <h5 class="mb-1">Lista de pólizas</h5>
                <p class="text-muted">No hay pólizas</p>
                        ...
                        <div class="row event-form">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback">Por favor ingrese el monto de la póliza</div>
                                    <?php if($balance->toArray()): ?> <?php if($balance[0]->saldo>0): ?> <div class="external-event fc-event bg-soft-info text-info">Póliza Mínima $100.00, Saldo de su cuenta $<?php echo e(number_format($balance[0]->saldo,2)); ?></div>  <?php endif; ?>   <?php endif; ?>
...
function editEvent(data) {
    ...
    if (data_id == 'new-event') {
        document.getElementById('modal-title').innerHTML = "";
        document.getElementById('modal-title').innerHTML = "Agregar póliza";
