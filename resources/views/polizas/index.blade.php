        ...
        <div class="col-xl-3">
            <div class="card card-h-100">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-primary w-100" id="btn-new-event" {{$disable}}><i class="mdi mdi-plus"></i>Crear nueva póliza</button>
                        ...
                        <div class="row event-form">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    @if ($balance->toArray()) @if ($balance[0]->saldo>0) <div class="external-event fc-event bg-soft-info text-info">Póliza Mínima $100.00, Saldo de su cuenta ${{number_format($balance[0]->saldo,2)}}</div>  @endif   @endif
