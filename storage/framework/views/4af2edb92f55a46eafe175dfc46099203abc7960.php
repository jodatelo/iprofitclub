...
unset($__errorArgs, $__bag); ?>"
                                                name="dni" value="<?php echo e(old('dni')); ?>" id="dni"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    -->
                                    <div class="mb-4">
                                        Usuario referidor: <b><?php echo e(request()->referral); ?></b>
                                        <input name="ref" class="form-control <?php $__errorArgs = ['ref'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="hidden" value="<?php echo e(request()->referral); ?>">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iprofitclub\resources\views/auth/register.blade.php ENDPATH**/ ?>